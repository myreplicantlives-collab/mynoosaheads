      ...
      bodySections={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Glossy black-cockatoos (Calyptorhynchus lathami) feed on casuarina seeds in this area. They’re broadly similar in size to a sulphur-crested cockatoo (~45–50 cm) [Source: Higgins, P. J. (ed.) 1999, Handbook of Australian, New Zealand & Antarctic Birds, Volume 4: Parrots to Dollarbird, Oxford University Press — species accounts for Calyptorhynchus lathami and Cacatua galerita], and the males have a distinctive red tail panel.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Other residents: eastern grey kangaroos, goannas (lace monitors, typically ~1.2–1.5 m and occasionally larger) [Source: Atlas of Living Australia — open occurrence records for Varanus varius, https://biocache.ala.org.au/occurrences/search?q=Varanus%20varius; max confirmed length ~2 m is a record-size individual, not a typical adult], land mullet, scrub turkeys, and the occasional echidna. The whales pass north from June to August and south from September to November — the headlands are an easy spot.",
          ],
        },
        {
