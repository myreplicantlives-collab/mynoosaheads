...
const IMG_FARMERS_MARKET = {
  caption:
    "Noosa Farmers Market — Saturday morning at the Noosaville showgrounds.",
...
export const SHOPPING_CATEGORIES: ShoppingCategory[] = [
    ...
    places: [
      {
        ...
        linkToMore:
          "https://www.tourismnoosa.com.au/accommodation/hastings-street",
      ...
      },
      {
        ...
        linkToMore: "https://www.tourismnoosa.com.au/",
        linkLabel: "Find out more",
        badge: null,
        image: IMG_HASTINGS_STREET,
      },
  ...
  /* ----- Category 4 — Markets and local makers ----- */
  {
    ...
    hook:
      "Wednesday and Saturday are the Noosa-region market days — the regional food event on Saturday morning, the crafts-and-makers pilgrimage to Eumundi on Wednesday and Saturday, smaller community markets most Sundays in between.",
    ...
    places: [
      {
        ...
        whyWorthVisiting:
          "The Sunshine Coast's flagship food-and-produce market. Saturday morning at the Noosa AFL grounds — coffee, bread, fruit, vegetables, cheeses, ready-to-eat breakfast. The regional food event.",
      ...
      },
      {
        ...
        whyWorthVisiting:
          "Sunday morning markets at the Noosa Marina — produce, gifts, food stalls, the boat-watching crowd. Smaller and quieter than the Saturday Noosa Farmers Market; the Sunday that suits a river-side lunch.",
