...
export const SEARCHABLE_PAGES = [
  ...
  { label: "Noosa surf lessons", href: "/things-to-do/surf-lessons", category: "Do", pitch: "Four Main Beach surf schools." },
  { label: "Noosa River cruises", href: "/things-to-do/river-cruises", category: "Do", pitch: "Ferry, lunch cruise, sunset charter." },
  { label: "Noosa Everglades tours", href: "/things-to-do/everglades-tours", category: "Do", pitch: "Cruise + kayak tours on the upper Noosa River." },
  { label: "Best places to stay in Noosa", href: "/accommodation/best-places-to-stay-in-noosa", category: "Stay", pitch: "The hub for the 13-cluster accommodation guide." },
